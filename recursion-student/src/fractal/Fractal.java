...
public class Fractal {
	...
	private void drawKochCurve(Point2D p1, Point2D p2, int level) {
		...
		t.move(d / 3);
		Point2D p3 = t.getPosition();
		t.turnLeft(60);
		t.move(d / 3);
		Point2D p4 = t.getPosition();
		t.turnRight(120);
		t.move(d / 3);
		Point2D p5 = t.getPosition();
		level--;
	...
	private void drawTree(Point2D p1, Point2D p2, int level) {
		...
		t.move(2 * d / 3);
		Point2D p4 = t.getPosition();
		Turtle t2 = new Turtle(p1, p2);
		t2.move(d / 3);
		t2.turnRight(15);
		t2.move(2 * d / 3);
		Point2D p5 = t2.getPosition();
		level--;
	...
	private void drawSierpinskiTriangle(Point2D p1, Point2D p2, Point2D p3, int level) {
		...
		drawSierpinskiTriangle(p1, p4, p6, level);
		drawSierpinskiTriangle(p4, p2, p5, level);
		drawSierpinskiTriangle(p6, p5, p3, level);
	...
	private void drawSierpinskiCarpet(Point2D p, double a, int level) {
		...
		Point2D p1 = new Point2D.Double(p.getX(), p.getY() + a / 3);
		Point2D p2 = new Point2D.Double(p.getX(), p.getY() + 2 * a / 3);
		Point2D p3 = new Point2D.Double(p.getX() + a / 3, p.getY());
		Point2D p5 = new Point2D.Double(p.getX() + a / 3, p.getY() + 2 * a / 3);
		Point2D p6 = new Point2D.Double(p.getX() + 2 * a / 3, p.getY());
		...
		drawSierpinskiCarpet(p8, a / 3, level);
