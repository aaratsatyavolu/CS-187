...
public class BSTNode<T extends Comparable<T>> implements BSTNodeInterface<T> {
	...
	public BSTNode<T> getUncle() {
		BSTNode<T> grand = this.getGrandParent();
		if (grand.left == this.getParent())
			return grand.right;
		else
			return grand.left;
	}
	...
	public boolean isOutside() {
		return (this == this.getGrandParent().left.left) || (this == this.getGrandParent().right.right);
	}
	
	public boolean isInside() {
		return (this == this.getGrandParent().left.right) || (this == this.getGrandParent().right.left);
	}
