...
public class RunTests {
	...
	public static void testValidBST() {
		...
		System.out.println("An empty tree is valid BST, and your answer is: " + bst.alternateIsValid());

		bst = new BST<Integer>(new BSTNode<Integer>(10));
		System.out.println("A tree with only a root is valid BST, and your answer is: " + bst.alternateIsValid());
		...
		System.out.println("test1.isValid() should be true, and your answer is " + bst.alternateIsValid());
		...
		System.out.println("test2.isValid() should be false, and your answer is " + bst.alternateIsValid());
		...
		System.out.println("test3.isValid() should be false, and your answer is " + bst.alternateIsValid());
	}
	...
	@Test
	public void testLCA() {
		BST<Integer> t = new BST<Integer>(new Integer[] { 8, 10, 12, 15, 16, 20, 25 });
		BSTNode<Integer> n = t.findLCA(8, 12);
