...
public class HashtableTest {
	...
	private void testlinearget(int nelements) {
		...
		System.out.println("Total insertion time: " + interval + ", per 1K element cost: "
				+ ((float) interval / nelements * 1000));
	...
	public void testlinearget() {
		// A test that checks the hash table insertion time as number of elements scales
		// up
		// ALso compares search time in hash table vs. using linear search (search in
		// unsorted array).
		// Use System.currentTimeMillis() to get the current time in milliseconds and
		// calculate the run time of program.
