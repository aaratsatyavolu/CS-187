...
public class Solver<T> {
	...
	/**
	 * Finds and returns a valid solution to the problem using recursive depth-first
	 * search.
	 * 
	 * The solution will either be a list of states from the initial state to a goal
	 * state, or the empty list (if no solution was found).
	 * 
	...
	/**
	 * Finds and returns a valid solution to the problem using iterative depth-first
	 * search.
	 * 
	 * The solution will either be a list of states from the initial state to a goal
	 * state, or the empty list (if no solution was found).
	...
	/**
	 * Finds and returns a valid solution to the problem using breadth-first search.
	 * 
	 * The solution will either be a list of states from the initial state to a goal
	 * state, or the empty list (if no solution was found).
	 * 
