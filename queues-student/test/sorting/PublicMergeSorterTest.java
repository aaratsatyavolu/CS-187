...
public class PublicMergeSorterTest {
	...
	@Test
	public void testing() {
		Queue<Integer> unsorted = new Queue<Integer>(), t = new Queue<Integer>(), n = new Queue<Integer>();
		...
		for (int i : new int[] { 2, 7, 5, 4 }) {
			n.enqueue(i);
		}

		System.out.println(ms.merge(unsorted, t).toString());
		System.out.println(ms.mergeSort(n).toString());
